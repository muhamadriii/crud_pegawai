        ...
        <div class="card-body">
            <form method="POST" action="{{ route('pegawai.update', $data->id)}}">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="born_place" name="born_place" value="{{ $data->born_place}}">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <select class="form-select" id="kelurahan_code" name="kelurahan_code">
                    ...
                    <option  {{ $data->kelurahan_code == $item->code ? 'selected' : '';}} value="{{ $item->code}}">{{ $item->name}}</option>
                    @endforeach
                  </select>
                </div>
                <div class="mb-3">
